...
double Nmea0183_Data::latLonToDouble(const char *data, const char sign) {
...
double Nmea0183_Data::kmToNm(double *data)
{
	return (*data / 1.852);
}
//*****************************************************************************
double Nmea0183_Data::timeToSeconds(const char *data, uint16_t offsetHour, uint16_t offsetMinute) {
	double val = atof(data);
...
const char *Nmea0183_Data::getData(int dataIndex)
{
...
bool Nmea0183_Data::compute(Nmea0183_Frame * frame)
{
	bool result = false;
	dataType = None;
	_frame = frame;
...
void Nmea0183_Data::selectSentenceFunction(char *sentence)
{
...
void Nmea0183_Data::_GGA() 
{
	...
	dataType = PositionNavigation;
}
void Nmea0183_Data::_GLL()
{
	dataPosition.clear();
	dataNavigation.clear();
...
void Nmea0183_Data::_ROO()
{}
void Nmea0183_Data::_RMA() 
{
	dataPosition.clear();
	dataNavigation.clear();
...
void Nmea0183_Data::addSentence(char *sentence)
{
...
void Nmea0183_Data::removeSentence(char *sentence)
{
...
void Nmea0183_Data::clearAllSentence()
{
	for (uint16_t i = 0; i < SENTENCE_LIST_MAX_LENGTH; i++)
	{
		if (!strcmp(validSentence[i], "---"))
...
void Nmea0183_Data::printSentenceList()
{
...
void Nmea0183_Data::printEngine()
{
...
void Nmea0183_Data::printNavigation()
{
	...
	if (strcmp(dataNavigation.date, 0)) { Serial.print("date\t\t"); Serial.println(dataNavigation.date); }
}
void Nmea0183_Data::printPosition()
{
...
void Nmea0183_Data::printWeather()
{
...
void Nmea0183_Data::printWaypoint()
{
